...
public class PlaceCargoMidPositionNoMovement extends SequentialCommandGroup {
  ...
  public PlaceCargoMidPositionNoMovement(SwerveSubsystem s_swerve, ArmSubsystem3 s_arm3, ExtenderSubsystem s_extender, ClawSubsystem s_claw) {
    m_swerve = s_swerve;
    m_arm3 = s_arm3;
    ...
    addCommands(
       ...
       m_swerve.runOnce(() -> m_swerve.drive(new Translation2d(ShoulderConstants.kGridOffset, 0).
        ...
        new WaitCommand(.6),
       m_swerve.runOnce(() -> m_swerve.drive(new Translation2d(0, 0).times(Constants.Swerve.gridMaxSpeed),0,false,false)),
