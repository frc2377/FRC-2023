...
//command for quarter speed swerve
...
public class QuarterSpeed extends CommandBase {
  ...
  public void execute() {
    ...
    /* Drive */
    s_Swerve.drive(
        new Translation2d(translationVal, strafeVal).times(Constants.Swerve.maxQuarterSpeed),
        rotationVal * Constants.Swerve.maxQuarterAngularVelocity,
