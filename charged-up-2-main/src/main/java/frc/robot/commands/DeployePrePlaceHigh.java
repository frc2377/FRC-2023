...
public class DeployePrePlaceHigh extends SequentialCommandGroup {
  ...
  public DeployePrePlaceHigh(SwerveSubsystem s_swerve, ArmSubsystem3 s_arm3, ExtenderSubsystem s_extender, ClawSubsystem s_claw, DeployMode s_mode) {
    m_swerve = s_swerve;
    m_arm3 = s_arm3;
