...
public class DeployTwoCubesBlue extends SequentialCommandGroup {
  /** Creates a new TestAuto. */
  public DeployTwoCubesBlue(SwerveSubsystem s_Swerve,IntakeSubsystem s_Intake, ArmSubsystem3 s_arm3, ExtenderSubsystem s_extender, ClawSubsystem s_claw, ModeSubsystem s_mode_subsystem) {
    ...
    Trajectory moveForward =
        TrajectoryGenerator.generateTrajectory(
            ...
            List.of(new Translation2d(1, Distance4),new Translation2d(2, Distance4),
            new Translation2d(3, Distance4)),
            // End on scale
    ...
    Trajectory moveBackward =
        TrajectoryGenerator.generateTrajectory(
            ...
            // Move out of community
            List.of(new Translation2d(3, Distance4),
            new Translation2d(2, Distance4),new Translation2d(1, Distance4)),
            // End on scale
    ...
    SwerveControllerCommand swerveControllerForward =
      ...
      SwerveControllerCommand swerveControllerBackward =
        new SwerveControllerCommand(
           ...
           new PIDController(Constants.AutoConstants.kPYController, 0, 0.12),
           thetaController,
           () -> Rotation2d.fromDegrees(180.10),//  this is blue value 
           s_Swerve::setModuleStates,
           s_Swerve);
