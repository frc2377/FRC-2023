...
3.) (2, 0)
4.) (3, 0) 
5.) (5.3, 0.36576) Distance2 Assumes the cube is 14.4 inches to the left of the cone target 

Reverse Trajectory
1.) (5.3, 0.36576) Distance2 Assumes the cube is 14.4 inches to the left of the cone t
2.) (3, -0.15) Distance3 veer right (5.9 inches to the left)
...
Distance Assumes the cube target is 16 inches to the left from the start up position of the robot
 */


public class AutoConeCubeRed extends SequentialCommandGroup {
   
  /** Creates a new AutoConeCubeBlue. */
  public AutoConeCubeRed(SwerveSubsystem s_Swerve, ArmSubsystem3 s_arm3, ExtenderSubsystem s_extender, ClawSubsystem s_claw,  ModeSubsystem s_mode_subsystem, IntakeSubsystem s_Intake) {
    // Add your commands in the addCommands() call, e.g.
    double Distance = 0;
    double Distance2 = 0;
    double Distance3 = 0;
    Distance = 0.254;// the offset to get to the endpoint(to get to the cube grid)
    Distance2 = 0.36576;// distance to the left to gather the cube.
    Distance3 = -0.15; // the value to swing out to the right
